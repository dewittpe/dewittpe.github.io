...
will be an important part of your research for the foreseeable future.  The R
package, Python module, and example [SQL code](https://cu-dbmi-peds.github.io/phoenix/articles/sql.html)
have been provided to simplify the implementation of the Phoenix criteria.

## Links:

- [Package website](https://cu-dbmi-peds.github.io/phoenix/)
